  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        ' <div class="box1">' +
        '   <label></label>' +
        '   <span STYLE="display:none" class="info-container">' +
        ...
        '   <div class="">' +
        '     <button type="button" class="col-xs-12 btn moveall">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '     <button STYLE="display:none" type="button" class="btn move">' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
        ...
        '     <button type="button" class="col-xs-12 btn removeall">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
