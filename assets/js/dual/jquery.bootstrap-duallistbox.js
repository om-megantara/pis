...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: 'Tampil Semua',
      filterPlaceHolder: 'Ketik Kode Barang',
      moveSelectedLabel: 'Move selected',
      moveAllLabel: 'Pindah Semua',
      removeSelectedLabel: 'Hapus Pilihan',
      ...
      infoText: 'Tampil Semua {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Tersaring</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Tidak ada Pilihan',                                                        // when there are no options present in the list
