...
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            Input Hasil Produksi Kawat Duri
        </h1>
    </div><!-- /.page-header -->
    <div class="page-content">
        <!--<div id="page-wrapper">
        ...
        <div class="row">
            <form id="frm_kd" name="frm_kd" action="<?= base_url('produksi/simpan_kd'); ?>" method="POST" onSubmit="return cek(this);">
                <!-- ----------------------------------------------------Header------------------------------------------ -->
                <div class="col-lg-12">
                    <div class="col-lg-4">
                    ...
                    <!--<div class="col-lg-3">
							<div class="form-group">
								<label>Ukuran</label>
								<input class="form-control" name="txtukuran" id="txtukuran" placeholder="Ukuran Berat" required>
