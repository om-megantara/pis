...
<div class="page-content">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="frm_wdpc" name="frm_wdpc" action="<?= base_url('produksi/simpan_wdpc'); ?>" method="POST" onSubmit="return cek(this);">
                <!-- ----------------------------------------------------Header------------------------------------------ -->
                <div class="col-lg-12">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="txtsisa_sesudah" id="txtsisa_sesudah" readonly="">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label>Sisa Keluar</label>
                            <input class="form-control" name="txtsisa_keluar" id="txtsisa_keluar">
                            <!--<p class="help-block">Example block-level help text here.</p>-->
                        </div>
                    </div>
                    <div class="row"></div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="txtdia_dies" id="txtdia_dies">
                            <!--<p class="help-block">Example block-level help text here.</p>-->
                        </div>
                    </div>
                    <div class="col-lg-4">
    ...
    <script>
        ...
        function cek() {
            ...
            var sisa_proses = conv2desimal(document.getElementById("txtsisa_sesudah").value);
            ...
            if (pengawas == "-Pilih Pengawas-") {
                ...
                return false;
            } else if (sisa_proses < 0) {
                alert('Sisa Sesudah kurang dari 0, cek kembali data yang di inputkan');
                return false;
            } else {
                //return true;
            }
        ...
        function totalx() {
            ...
            //document.getElementById("total_roll").value = conv2desimal(Number(hasil_bk_rol)); 
            ...
            //document.getElementById("total_berat").value = conv2desimal(Number(hasil_bk_berat)); 
            ...
            var sisa_proses = conv2desimal((Number(bahan_bawl) + Number(bahan_bakh)) - (Number(hasil_bk_berat) + Number(aval_baik) + Number(aval_ruwet)));
            if (sisa_proses < 0) {
                alert('Sisa Sesudah kurang dari 0, cek kembali data yang di inputkan');
                return false;
            } else {
