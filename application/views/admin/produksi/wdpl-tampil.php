    ...
    <div class="page-content">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <!--<form role="form" id="frm_wdpl" name="frm_wdpl">
					<!-- ----------------------------------------------------Header------------------------------------------ -->
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="col-lg-4">
                                ...
                                <a href="<?= base_url('produksi/input-wdpl'); ?>" data-toggle="modal" class="btn btn-info">
                                    <i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
                                </a>
                            </div>
                            <form id="frm_wdpl" name="frm_wdpl" action="<?= base_url('produksi/tampil-wdpl'); ?>" method="POST">
                                <div class="col-lg-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($link, "SELECT * FROM wdpl where status_del='0'" . $fbulan . " order by kd Desc") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <td>
                                                <center><a href="<?= base_url('produksi/edit-wdpl/' . $kd); ?>"><i class="fa fa-edit"></i> Edit</a></center>
                                                <center><a href="<?= base_url('produksi/hapus_wdpl/' . $kd); ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>

                                            <!-- <?php if ($login = "") { ?>
                                                    <center><a href="?p=hapus-wdpl&kd=<?php echo $kd; ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>
                                        <?php } else {
                                                        echo "</td>";
                                                    } ?> -->
