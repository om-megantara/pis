...
// $test = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM users where username='$login'")) or die(mysqli_error($link));
//$rowt = mysqli_fetch_array($test);
//$hapus=$rowt["hapus"];
//echo $hapus;
//echo $login;
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="col-lg-4">
                                ...
                                <a href="<?= base_url('produksi/input-galvanis'); ?>" data-toggle="modal" class="btn btn-info">
                                    <i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
                                </a>
                            </div>

                            <form id="frm_galv" name="frm_galv" action="<?= base_url('produksi/tampil-galvanis'); ?>" method="POST">
                                <div class="col-lg-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($link, "SELECT * FROM galvanis where status_del='0'" . $fbulan . " order by kd Desc") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <td>
                                                <center><?php echo $no_orker; ?></center>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <!-- <center><a href="?p=update-galvanis&kd=<?php echo $kd; ?>"><i class="fa fa-edit"></i> Edit</a></center> -->
                                                <center><a href="<?= base_url('produksi/edit-galv/' . $kd); ?>"><i class="fa fa-edit"></i> Edit</a></center>
                                                <center><a href="<?= base_url('produksi/hapus_galvanis/' . $kd); ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                                <!-- <?php //if ($login != ""){
                                                        if ($rowt['hapus'] == "1") {
                                                        ?>
                                                    <center><a href="?p=hapus-galvanis&kd=<?php echo $kd; ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>
                                        <?php } else {
                                                            echo "</td>";
                                                        } ?> -->
