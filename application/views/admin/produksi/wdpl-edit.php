<div class="page-content">
    ...
    <div class="page-content">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="frm_wdpl" name="frm_wdpl" action="<?= base_url('produksi/update_wdpl'); ?>" method="POST" onSubmit="return cek(this);">
                    <?php foreach ($produksi_wdpl as $pwl) : ?>
                        <input type="hidden" name="kd" class="form-control" value="<?= $pwl->kd ?>">
                        <!-- ----------------------------------------------------Header------------------------------------------ -->
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>No. Order Kerja</label>
                                    <input class="form-control" name="txtno_orker" id="txtno_orker" value="<?php echo $pwl->no_orker; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Pengawas (Pilih Pengawas)</label>
                                    <select class="form-control" id="txtpengawas" name="txtpengawas" required>
                                        <option>
                                            <selected><?php echo $pwl->pengawas; ?></selected>
                                        </option>
                                        <option>Ainul</option>
                                        <option>Hani</option>
                                        <option>Yitno</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtoperator" id="txtoperator" required>
                                        <option>
                                            <selected><?php echo $pwl->operator; ?></selected>
                                        </option>
                                        <?php
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtunit" id="txtunit">
                                        <option value="<?php echo $pwl->Unit; ?>">
                                            <selected><?php echo "Unit " . $pwl->Unit; ?></selected>
                                        </option>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtshif" id="txtshif" required>
                                        <option>
                                            <selected><?php echo $pwl->shif; ?></selected>
                                        </option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input class="form-control date-picker" readonly="readonly" name="txttgl" id="txttgl" type="text" data-date-format="dd-mm-yyyy" placeholder="Tanggal Produksi" value="<?php echo $pwl->tanggal; ?>" required />
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtdiameter" id="txtdiameter" placeholder="Diameter kawat" required value="<?php echo $pwl->diameter; ?>">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtjml_jam" id="txtjml_jam" placeholder="Lama mengerjakan per diameter" required value="<?php echo $pwl->jam_kerja; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="bahan_baw" name="bahan_baw" onchange="totalx()" value="<?php echo $pwl->bahan_baku_aw; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="bahan_bak" name="bahan_bak" onchange="totalx()" value="<?php echo $pwl->bahan_baku_ak; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <!--<div class="row"></div>-->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="tot_bahanb" name="tot_bahanb" disabled="" value="<?php echo $pwl->bahan_baku_tot; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txthasilbaik_rol" id="txthasilbaik_rol" onchange="totalx()" value="<?php echo $pwl->hasil_baik_roll; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <!--<div class="col-lg-4">
							<div class="form-group">
								...
								<input class="form-control" name="txthasilsb_rol" id="txthasilsb_rol" onchange="totalx()" value="<?php echo $pwl->hasil_sb_roll; ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txthasilbaik_berat" id="txthasilbaik_berat" onchange="totalx()" value="<?php echo $pwl->hasil_baik_berat; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <!--<div class="col-lg-4">
							<div class="form-group">
								...
								<input class="form-control" name="txthasilsb_berat" id="txthasilsb_berat" onchange="totalx()" value="<?php echo $hasil_sb_berat; ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtaval_baik" id="txtaval_baik" onchange="totalx()" value="<?php echo $pwl->aval_baik; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtaval_ruwet" id="txtaval_ruwet" onchange="totalx()" value="<?php echo $pwl->aval_ruwet; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txttotal_aval" id="txttotal_aval" disabled="" value="<?php echo $pwl->aval_baik + $pwl->aval_ruwet; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txttotal_pakai" id="txttotal_pakai" disabled="" value="<?php echo $pwl->total_pemakaian; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtsisa_sesudah" id="txtsisa_sesudah" disabled="" value="<?php echo $pwl->sisa_sesudah; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtlubri" id="txtlubri" value="<?php //echo $pwl->lubri; 
                                                                                                        ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Sabun</label>
                                    <input class="form-control" name="txtsabun" id="txtsabun" value="<?php //echo $sabun; 
                                                                                                        ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtketerangan" id="txtketerangan" value="<?php echo $pwl->ket; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtkwh" id="txtkwh" placeholder="KWH selama 1 Shif" value="<?php echo $pwl->kwh_meter; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row"></div>
