                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($link, "SELECT * FROM kawat_duri where status_del='0'" . $fbulan . " order by kd Desc") or die('Query Error : ' . mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <td>
                                                ...
                                                <center><a href="<?= base_url('produksi/update-kd'); ?>&kd=<?php echo $kd; ?>"><i class="fa fa-edit"></i> Edit</a></center>
                                                <!-- <?php if ($login != "") { ?>
