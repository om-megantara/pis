<div class="page-content">
    ...
    <div class="page-content">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="frm_wdpc" name="frm_wdpc" action="<?= base_url('produksi/update_wdpc'); ?>" method="POST" onSubmit="return cek(this);">
                    <?php foreach ($produksi_wdpc as $pwc) : ?>
                        <input type="hidden" name="kd" class="form-control" value="<?= $pwc->kd ?>">
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtno_orker" id="txtno_orker" value="<?php echo $pwc->no_orker; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Pengawas (Pilih Pengawas)</label>
                                    <select class="form-control" id="txtpengawas" name="txtpengawas" required>
                                        <option>
                                            <selected><?php echo $pwc->pengawas; ?></selected>
                                        </option>
                                        <option>Ainul</option>
                                        <option>Hani</option>
                                        <option>Yitno</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtoperator" id="txtoperator" required>
                                        <option>
                                            <selected><?php echo $pwc->operator; ?></selected>
                                        </option>
                                        <?php
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtunit" id="txtunit">
                                        <option value="<?php echo $pwc->Unit; ?>">
                                            <selected><?php echo "Unit " . $pwc->Unit; ?></selected>
                                        </option>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtshif" id="txtshif" required>
                                        <option>
                                            <selected><?php echo $pwc->shif; ?></selected>
                                        </option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input class="form-control date-picker" readonly="readonly" name="txttgl" id="txttgl" type="text" data-date-format="dd-mm-yyyy" placeholder="Tanggal Produksi" value="<?php echo $pwc->tanggal; ?>" required />
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtdiameter" id="txtdiameter" placeholder="Diameter kawat" required value="<?php echo $pwc->diameter; ?>">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtjml_jam" id="txtjml_jam" placeholder="Lama mengerjakan per diameter" required value="<?php echo $pwc->jam_kerja; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="bahan_baw" name="bahan_baw" onchange="totalx()" value="<?php echo $pwc->bahan_baku_aw; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="bahan_bak" name="bahan_bak" onchange="totalx()" value="<?php echo $pwc->bahan_baku_ak; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <!--<div class="row"></div>-->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="tot_bahanb" name="tot_bahanb" disabled="" value="<?php echo $pwc->bahan_baku_tot; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txthasilbaik_rol" id="txthasilbaik_rol" onchange="totalx()" value="<?php echo $pwc->hasil_baik_roll; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txthasilsb_rol" id="txthasilsb_rol" onchange="totalx()" value="<?php echo $pwc->hasil_sb_roll; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="total_roll" id="total_roll" disabled="" value="<?php echo $pwc->total_rol; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txthasilbaik_berat" id="txthasilbaik_berat" onchange="totalx()" value="<?php echo $pwc->hasil_baik_berat; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txthasilsb_berat" id="txthasilsb_berat" onchange="totalx()" value="<?php echo $pwc->hasil_sb_berat; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="total_berat" id="total_berat" disabled="" value="<?php echo $pwc->total_berat; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtaval_baik" id="txtaval_baik" onchange="totalx()" value="<?php echo $pwc->aval_baik; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtaval_ruwet" id="txtaval_ruwet" onchange="totalx()" value="<?php echo $pwc->aval_ruwet; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txttotal_aval" id="txttotal_aval" disabled="" value="<?php echo $pwc->aval_ruwet + $pwc->aval_ruwet; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txttotal_pakai" id="txttotal_pakai" disabled="" value="<?php echo $pwc->total_pemakaian; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtsisa_sesudah" id="txtsisa_sesudah" disabled="" value="<?php echo $pwc->sisa_sesudah; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Sisa Keluar</label>
                                    <input class="form-control" name="txtsisa_keluar" id="txtsisa_keluar" value="<?php echo $pwc->sisa_keluar; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Dies</label>
                                    <select class="form-control" name="txtdies" id="txtdies" required>
                                        <option>
                                            <selected><?php echo $pwc->dies; ?></selected>
                                        </option>
                                        <option>Thungsten</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Diameter Dies (Baru)</label>
                                    <input class="form-control" name="txtdia_dies" id="txtdia_dies" value="<?php echo $pwc->dies; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Sabun</label>
                                    <input class="form-control" name="txtsabun" id="txtsabun" value="<?php //echo $pwc->sabun; 
                                                                                                        ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="txtketerangan" id="txtketerangan" value="<?php echo $pwc->ket; ?>"></textarea>
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtkwh" id="txtkwh" placeholder="KWH selama 1 Shif" value="<?php echo $pwc->kwh_meter; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row"></div>
        ...
        <script>
            ...
            function totalx() {
                var bahan_bawl = document.getElementById("frm_wdpc").bahan_baw.value;
                var bahan_bakh = document.getElementById("frm_wdpc").bahan_bak.value;
                document.getElementById("tot_bahanb").value = conv2desimal(Number(bahan_bawl) + Number(bahan_bakh));

                var hasil_bk_rol = document.getElementById("frm_wdpc").txthasilbaik_rol.value;
                //var hasil_sb_rol=document.getElementById("frm_wdpc").txthasilsb_rol.value;
                //document.getElementById("total_roll").value = conv2desimal(Number(hasil_bk_rol)+Number(hasil_sb_rol)); 

                var hasil_bk_berat = document.getElementById("frm_wdpc").txthasilbaik_berat.value;
                //var hasil_sb_berat=document.getElementById("frm_wdpc").txthasilsb_berat.value;
                //document.getElementById("total_berat").value = conv2desimal(Number(hasil_bk_berat)+Number(hasil_sb_berat)); 

                var aval_baik = document.getElementById("frm_wdpc").txtaval_baik.value;
                var aval_ruwet = document.getElementById("frm_wdpc").txtaval_ruwet.value;
