                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="col-lg-4">
                                ...
                                <a href="<?= base_url('produksi/input-kd'); ?>" data-toggle="modal" class="btn btn-info">
                                    <i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
                                </a>
                            </div>
                            <form id="frm_kd" name="frm_kd" action="<?= base_url('produksi/tampil-kd'); ?>" method="POST">
                                <div class="col-lg-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($link, "SELECT * FROM kawat_duri where status_del='0'" . $fbulan . " order by kd Desc") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <td>
                                                <center><?php echo $ukuran; ?></center>
                                            </td>
                                            <td>
                                                <!-- <center><a href="?p=update-kd&kd=<?php echo $kd; ?>"><i class="fa fa-edit"></i> Edit</a></center> -->
                                                <center><a href="<?= base_url('produksi/edit-kd/' . $kd); ?>"><i class="fa fa-edit"></i> Edit</a></center>
                                                <center><a href="<?= base_url('produksi/hapus_kd/' . $kd); ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>

                                            <!-- <?php if ($login = "") { ?>
                                                    <center><a href="?p=hapus-kd&kd=<?php echo $kd; ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>
                                        <?php } else {
                                                        echo "</td>";
                                                    } ?> -->
