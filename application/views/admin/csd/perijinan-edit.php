    ...
    <div class="page-content">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <form id="frm_csdijin" name="frm_csdgalv" action="<?= base_url('csd/update_perijinan'); ?>" method="POST" onSubmit="return cek();">

                        <?php foreach ($csd_perijinan as $cp) : ?>

                            <input type="hidden" name="no_kd" class="form-control" value="<?= $cp->no_kd ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="txtnama_berkas" id="txtnama_berkas" required placeholder="Nama Berkas" rows="3" cols="40"><?php echo $cp->nama_berkas; ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>No. Kendaraan/Nomor Surat</label>
                                    <input class="form-control" name="txtno_kendaraan" id="txtno_kendaraan" required placeholder="Nomor Surat atau Nomor Kendaraan" value="<?php echo $cp->nomor_kendaraan; ?>">
                                </div>
                            </div>txtjns_berkas
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" onchange="pengawas()" id="txtjns_berkas" name="txtjns_berkas">
                                        <option><?php echo $cp->jenis_berkas; ?></option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="txtnm_lembaga" id="txtnm_lembaga" required placeholder="Lembaga/Instansi Penerbit Surat/Ijin" rows="3" cols="40"><?php echo $cp->Nama_lembaga; ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input class="form-control date-picker" readonly="readonly" name="txttgl_terbit" id="txttgl_terbit" type="text" data-date-format="yyyy-mm-dd" placeholder="Tanggal Produksi" value="<?php echo $cp->tgl_terbit; ?>" />
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtmasa_berlaku" id="txtmasa_berlaku" required placeholder="Masa Berlaku Berkas/Surat" value="<?php echo $cp->masa_berlaku; ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="txtsatuan" id="txtsatuan">
                                        <option><?php echo $cp->satuan; ?></option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        <input class="form-control date-picker" readonly="readonly" name="txttgl_expired" id="txttgl_expired" type="text" data-date-format="yyyy-mm-dd" placeholder="Tanggal Expired" value="<?php echo $cp->tgl_expired; ?>" />
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <!--<input class="form-control" name="txtstatus_berkas" id="txtstatus_berkas" placeholder="Status Berkas" value="<?php echo $cp->status_berkas; ?>" >-->
                                    <select class="form-control" name="txtstatus_berkas" id="txtstatus_berkas">
                                        <option><?php echo $cp->status_berkas; ?></option>
                                        <option>Aktif</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="txtlama_urus" name="txtlama_urus" placeholder="Perkiraan waktu pengurusan berkas" value="<?php echo $cp->lama_pengurusan; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="txt_keterangan" name="txt_keterangan" placeholder="Keterangan" value="<?php echo $cp->keterangan; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <!--<div class="row"></div>-->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        <input class="form-control date-picker" readonly="readonly" name="txttgl_notif" id="txttgl_notif" type="text" data-date-format="yyyy-mm-dd" placeholder="Tanggal mulai notifikasi" value="<?php echo $cp->tgl_mulai_notif; ?>" />
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    </div>
                                </div>
                            </div>
