                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-3">
                                ...
                                <a href="<?= base_url('gudang/input-kp'); ?>" data-toggle="modal" class="btn btn-info">
                                    <i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
                                </a>
                            </div>

                            <form id="frm_galv" name="frm_galv" action="<?= base_url('gudang/tampil-kp'); ?>" method="POST">
                                <div class="col-lg-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($link, "SELECT * FROM gudang_paku where status_barang!='0'" . $fbulan . " order by tanggal Desc") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <td>
                                                <center><?php echo $kode_barang; ?></center>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <center><?php echo $jns_brg; ?></center>
                                            </td>
                                            <td>
                                                <center><?php echo $status_barang; ?></center>
                                            </td>
                                            <!--<td><center><a href="?p=edit-galvanis"><i class="fa fa-edit"></i> Edit</a></center></td>-->
                                            <td>
                                                <center><a href="<?= base_url('gudang/edit-kp/' . $kd); ?>"><i class="fa fa-edit"></i> Edit</a></center>
