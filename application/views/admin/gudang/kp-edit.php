...
$no = 1;
$totnet_gaji = 0;
// $result=mysql_query("SELECT * FROM gudang_paku where kode='$kd_edit'") or die(mysql_error());
...
<div class="page-content">
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <form id="updkp-simpan" name="updkp-simpan" action="<?= base_url('gudang/update_kp'); ?>" method="POST" onSubmit="return cek();">
                    <?php foreach ($tampilkp as $tkp) : ?>
                        <input type="hidden" name="kode" class="form-control" value="<?= $tkp->kode ?>">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input class="form-control date-picker" readonly="readonly" name="txttgl" id="txttgl" type="text" data-date-format="dd-mm-yyyy" value="<?php echo $tkp->tanggal; ?>" />
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtdiameter" id="txtdiameter" value="<?php echo $tkp->diameter; ?>">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtkode_barang" id="txtkode_barang" onchange="totalx()" value="<?php echo $tkp->kode_barang; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Berat</label>
                                    <input class="form-control" name="txtberat" id="txtberat" onchange="totalx()" value="<?php echo $tkp->berat; ?>">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" onchange="pengawas()" id="txtjenis_barang" name="txtjenis_barang" value="<?php echo $tkp->jns_brg; ?>">
                                        <Option>OK</Option>
                                        <Option>NG</Option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" onchange="pengawas()" id="txtstatus_barang" name="txtstatus_barang">
                                        <option>
                                            <selected><?php echo $tkp->status_barang; ?></selected>
                                        </option>
                                        <Option>Baru</Option>
                                        <Option>Sisa</Option>
                                    </select>
