...
<div class="page-header">
    <h1>
        Mutasi Buffer Kawat Paku Coil (KPC)
    </h1>
</div><!-- /.page-header -->
<form id="demoform5p" action="?p=mut-gdgkpc-proses" method="post">
    ...
    <div class="col-sm-8">
        <select multiple="multiple" size="10" name="duallistbox_demo2[]" id="duallistbox_demo2[]">
            ...
            // $link = mysqli_connect("localhost:3307", "root", "", "produksi");
            $tampil = mysqli_query($link, "select * from gudang_paku where status_gudang='2.1' And status_barang != 'Habis' order by kode");
            $no = 1;
            $jumtot = 0;
