...
if (isset($_POST["btn_proses"])) {
    ...
    if ($bln == "all") {
        ...
        $fbulan = "where tanggal_masuk like '%$thn1-$bln-%'";
    }
    //echo $bag;				
    $thn = date("Y");
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-3">
                                ...
                                <a href="<?= base_url('gudang/input-zn'); ?>" data-toggle="modal" class="btn btn-info">
                                    <i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
                                </a>
                            </div>
                            <form id="frm_zn" name="frm_zn" action="<?= base_url('gudang/tampil-zn'); ?>" method="POST">
                                <div class="col-lg-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    <?php
                                    //foreach ($tampilzn as $tzn) 


                                    $no = 1;
                                    $totnet_gaji = 0;
                                    //$result=mysqli_query($link, "SELECT * FROM drawing_bhn ".$fbulan." order by tanggal_masuk, kd_bhn Desc") or die(mysqli_error($link));
                                    // $link = mysqli_connect("localhost:3307", "root", "", "produksi");
                                    include "application/config/database.php";
                                    $result = mysqli_query($link, "SELECT * FROM gdg_zn " . $fbulan . " order by no_kode Desc") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <td>
                                                <center><a href="<?= base_url('gudang/edit-zn/' . $kd); ?>"><i class="fa fa-edit"></i> Edit</a></center>
                                                <center><a href="<?= base_url('gudang/hapus_zn/' . $kd); ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>

                                            <!-- <?php if ($login = !"") { ?>
                                                    <center><a href="?p=hapus-zn&kd=<?php echo $kd; ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>
                                        <?php } else {
                                                        echo "</td>";
                                                    } ?> -->
