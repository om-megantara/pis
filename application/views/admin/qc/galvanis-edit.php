    ...
    <div class="page-content">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <form id="frm_qc_galv" name="frm_qc_galv" action="<?= base_url('qc/simpan-galvanis'); ?>" method="POST" onSubmit="return cek()">
                        <!-- <input type="hidden" name="kd_qc_galv" class="form-control" value="<?= $ig->kd_qc_galv ?>"> -->
                        <?php foreach ($input_galv as $ig) : ?>
                            <input type="hidden" name="kd_galv" class="form-control" value="<?= $ig->kd ?>">
                            <input type="hidden" name="no_order" class="form-control" value="<?= $ig->no_orker ?>">
						...
						<!--<div class="form-group">
							...
							<input class="form-control" name="txtno_orker" id="txtno_orker" value="<?php echo $no_order; ?>" hidden="hidden">
						</div>-->
                            <!--<div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input class="form-control" readonly="readonly" name="txttgl" id="txttgl" type="text" value="<?php echo $ig->tanggal; ?>" />
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                        <input class="form-control" readonly="readonly" name="shif" id="shif" type="text" value="<?php echo $ig->shif;
                                                                                                                                    $no_order ?>" />
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                        <input class="form-control" readonly="readonly" name="txtunit" id="txtunit" type="text" value="<?php echo $ig->Unit ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtdiameter" id="txtdiameter" value="<?php echo $ig->diameter; ?>" readonly="readonly">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                        <input class="form-control" readonly="readonly" name="txthasil_baik_roll" id="txthasil_baik_roll" type="text" value="<?php echo $ig->hasil_baik_roll; ?>" />
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                        <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                        <input class="form-control" readonly="readonly" name="txthasil_baik_berat" id="txthasil_baik_berat" type="text" value="<?php echo $ig->hasil_baik_berat; ?>" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>NG Hitam (Coil)</label>
                                <input class="form-control" name="txtng_hitam" id="txtng_hitam" value="<?php //echo $ng_hitam; 
                                                                                                        ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>NG Sisa Tali Timah (Coil)</label>
                                <input class="form-control" name="txtng_sisa_talitimah" id="txtng_sisa_talitimah" value="<?php //echo $ng_sisa_talitimah; 
                                                                                                                            ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>NG Oli (Coil)</label>
                                <input class="form-control" name="txtng_oli" id="txtng_oli" value="<?php //echo $ng_oli; 
                                                                                                    ?>">
    ...
    <script>
        ...
        function cek() {
            ...
            var ng_kasar = document.getElementById("txtng_kasar_rol").value;
            var ng_kusam = document.getElementById("txtng_kusam_rol").value;
            var ng_gosong = document.getElementById("txtng_gosong_rol").value;
            var ng_merah = document.getElementById("txtng_merah_rol").value;
            var ng_ruwet = document.getElementById("txtng_ruwet_rol").value;
            var ng_oval = document.getElementById("txtng_dia_oval_rol").value;
            var ng_outspec = document.getElementById("txtng_dia_osp_rol").value;
            var ng_kaku = document.getElementById("txtng_kaku_rol").value;
            var ng_cw = document.getElementById("txtng_cw_rol").value;
            var ng_lengket = document.getElementById("txtng_lengket_rol").value;
            var ng_karat = document.getElementById("txtng_karat_rol").value;
            var ng_sambungan = document.getElementById("txtng_sambungan_rol").value;
            var ng_gelombang = document.getElementById("txtng_gelombang_rol").value;

            ng_rolc = conv2desimal(Number(ng_kasar) + Number(ng_kusam) + Number(ng_gosongng) + Number(ng_merah) + Number(ng_ruwet) + Number(ng_oval) + Number(ng_outspec) + Number(ng_kaku) + Number(ng_cw) + Number(ng_lengket) + Number(ng_karat) + Number(ng_sambungan) + Number(ng_gelombang));
            ...
            if (pas_rol == "") {
                ...
                return false;
            } else if (ng_rolc != ng_rol) {
                alert("Total Rol/Coil NG tidak sama dengan Total Jenis NG, Silahkan di CEK ulang!");
                //alert(total_rol);
                //alert(total_berat);
                return false;
