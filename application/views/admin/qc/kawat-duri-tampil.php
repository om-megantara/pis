...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Input Data Kawat Duri</li>
    </ul><!-- /.breadcrumb -->
</div>
    ...
    <div class="page-content">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <!--<form role="form" id="frm_qckd" name="frm_qckd">-->
                    <!-- ----------------------------------------------------Header------------------------------------------ -->
                    <div class="row">
                        <div class="col-lg-8">
                            <!--<h2>Data Produksi wdpl</h2>
							<!--<div class="col-lg-6">
							<h4><a href="?p=input-kd"><i class="fa fa-pencil"></i> Masukkan Data Baru</button></a></h4>
						</div>-->
                            <!--<div class="col-lg-4">
							<label>Masukkan data Baru</label>
							<a href="?p=input-kd" data-toggle="modal" class="btn btn-info">
								<i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
							</a>
						</div>-->

                            <form id="frm_qckd" name="frm_qckd" action="<?= base_url('qc/hasil-kd'); ?>" method="POST">
                                <div class="col-lg-4">
                            ...
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <!--<th width="10%" ><center>Team</center></th>-->
                                        <th width="15%">
                                            <center>Unit</center>
                                        </th>
                                        <th width="15%">
                                        ...
                                        <!--<th width="15%" ><center>Diameter</center></th>-->
                                        <th width="10%">
                                            <center>Aksi</center>
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $totnet_gaji = 0;
                                    //$result=mysql_query("SELECT * FROM kawat_duri where status_qc='0' AND status_del='0'".$fbulan." order by tanggal Desc") or die(mysql_error());
                                    //$result=mysql_query("SELECT * FROM kawat_duri where status_del='0'".$fbulan." order by tanggal Desc") or die(mysql_error());
                                    // $link = mysqli_connect("localhost:3307", "root", "", "produksi");

                                    include "application/config/database.php";

                                    $result = mysqli_query($link, "SELECT kawat_duri.* FROM kawat_duri LEFT JOIN qc_kd ON kawat_duri.kd=qc_kd.kd_galv WHERE qc_kd.kd_galv IS NULL AND kawat_duri.status_del='0'" . $fbulan . " order by kawat_duri.tanggal") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <!--<td><center><a href="?p=edit-kd"><i class="fa fa-edit"></i> Edit</a></center></td>-->
                                            <td>
                                                <center><a href="<?= base_url('qc/edit-kd/' . $kd); ?>"><i class="fa fa-edit"></i> QC</a></center>
                                                <!-- <center><a href="<?= base_url('qc/hapus_kd/' . $kd); ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td> -->

                                                <?php if ($login == "7") { ?>
                                                    <center><a href="?p=hapus-qc-kd&kd=<?php echo $kd; ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>
                                        <?php } else {
                                                    echo "</td>";
                                                } ?>
