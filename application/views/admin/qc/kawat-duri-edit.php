<div class="page-content">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <form id="frm_qc_kd" name="frm_qc_kd" action="<?= base_url('qc/simpan-kd'); ?>" method="POST" onSubmit="return cek()">
                    <?php foreach ($input_kd as $ikd) : ?>
                        <input type="hidden" name="kd_galv" class="form-control" value="<?= $ikd->kd ?>">
                        <input type="hidden" name="no_order" class="form-control" value="<?= $ikd->no_orker ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                    ...
                                    <input class="form-control" readonly="readonly" name="txttgl" id="txttgl" type="text" value="<?php echo $ikd->tanggal; ?>" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                    <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                    <input class="form-control" readonly="readonly" name="shif" id="shif" type="text" value="<?php echo $ikd->shif;
                                                                                                                                $no_order ?>" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                    <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                    <input class="form-control" readonly="readonly" name="txtunit" id="txtunit" type="text" value="<?php echo $ikd->Unit ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="txtdiameter" id="txtdiameter" value="<?php //echo $ikd->diameter; 
                                                                                                        ?>" readonly="readonly">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                    <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                    <input class="form-control" readonly="readonly" name="txthasil_baik_roll" id="txthasil_baik_roll" type="text" value="<?php echo $ikd->hasil_baik_roll; ?>" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date " data-date="" data-date-format="dd-mm-yyyy">
                                    <!--<input class="form-control" type="text" name="txttgl" readonly="readonly">-->
                                    <input class="form-control" readonly="readonly" name="txthasil_baik_berat" id="txthasil_baik_berat" type="text" value="<?php echo $ikd->hasil_baik_berat; ?>" />
