...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Input Data wdpl</li>
    </ul><!-- /.breadcrumb -->
</div>
    ...
    <div class="page-content">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <!--<form role="form" id="frm_wdpl2" name="frm_wdpl2">-->
                    <!-- ----------------------------------------------------Header------------------------------------------ -->
                    <div class="row">
                        <div class="col-lg-8">
                            <!--<h2>Data Produksi wdpl</h2>
							<!--<div class="col-lg-6">
							<h4><a href="?p=input-wdpl"><i class="fa fa-pencil"></i> Masukkan Data Baru</button></a></h4>
						</div>-->
                            <!--<div class="col-lg-4">
							<label>Masukkan data Baru</label>
							<a href="?p=input-wdpl" data-toggle="modal" class="btn btn-info">
								<i class="ace-icon fa fa-plus bigger-160"></i>Tambah Data Baru
							</a>
						</div>-->

                            <form id="frm_wdpl2" name="frm_wdpl2" action="<?= base_url('qc/hasil-wdpl'); ?>" method="POST">
                                <div class="col-lg-4">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-striped" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $totnet_gaji = 0;
                                    //$result=mysql_query("SELECT * FROM wdpl where status_qc='0' AND status_del='0'".$fbulan." order by tanggal Desc") or die(mysql_error());
                                    //$result=mysql_query("SELECT * FROM wdpl where status_del='0'".$fbulan." order by tanggal Desc") or die(mysql_error());
                                    // $link = mysqli_connect("localhost:3307", "root", "", "produksi");
                                    include "application/config/database.php";
                                    $result = mysqli_query($link, "SELECT wdpl.* FROM wdpl LEFT JOIN qc_wdpl ON wdpl.kd=qc_wdpl.kd_galv WHERE qc_wdpl.kd_galv IS NULL AND wdpl.status_del='0'" . $fbulan . " order by wdpl.tanggal") or die(mysqli_error($link));
                                    ...
                                    ?>
                                        <tr class="<?php echo $wrn; ?>">
                                            ...
                                            <!--<td><center><a href="?p=edit-wdpl"><i class="fa fa-edit"></i> Edit</a></center></td>-->
                                            <td>
                                                <center><a href="<?= base_url('qc/edit-wdpl/' . $kd); ?>"><i class="fa fa-edit"></i> QC</a></center>
                                                <!-- <center><a href="<?= base_url('qc/hapus_wdpl/' . $kd); ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td> -->

                                                <?php if ($login == "7") { ?>
                                                    <center><a href="?p=hapus-qc-wdpl&kd=<?php echo $kd; ?>"><i class="fa fa-remove"></i> Hapus</a></center>
                                            </td>
                                        <?php } else {
                                                    echo "</td>";
                                                } ?>
