...
?>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <h4>Hasil Produksi WD PL Baik dan Hold (Tim: <?php echo $tim; ?>)</h5>
                    <table id="tberat" class="table table-bordered table-hover table-striped" border="1">
                        ...
                        <tbody>
                            ...
                            if ($tim == "-Semua Operator-") {
                                //$sql2   = "SELECT tanggal,sum(hasil_baik_berat) as baik, sum(hasil_sb_berat) as sb from wdpl where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak' group by tanggal";
                                header('location: nsm.php?p=chart-sum-wdpl&aw=' . $aw . '&ak=' . $ak . '&tim=' . $tim);
                            } else {
                                //$syarat_tim="";
                                $sql2 = "SELECT tanggal,hasil_baik_berat as baik,hasil_sb_berat as sb from wdpl where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak'" . $syarat_tim . " AND status_del='0' group by tanggal";
                                //$sql2   = "SELECT tanggal,hasil_baik_berat as baik,hasil_sb_berat as sb from wdpl where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak' AND team='$tim' group by tanggal";
                            }
                            //include "koneksi.php";
                            //$sql2   = "SELECT tanggal,sum(hasil_baik_berat) as baik, sum(hasil_sb_berat) as sb from wdpl where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak'".$syarat_tim."group by tanggal";
                            $link = mysqli_connect("localhost:3307", "root", "", "produksi");
