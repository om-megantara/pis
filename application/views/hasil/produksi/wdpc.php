...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    ...
    <div class="col-lg-12">
        ...
        <form method="POST" action="<?= base_url('hasil/produksi-wdpc'); ?>">
            <div class="row"></div>
            <div id="page-wrapper">
...
?>
    ...
    <div class="col-lg-12">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <h2>Laporan Produksi WDPC periode: <?php echo $_POST["txttgl_aw"] . " sampai " . $_POST["txttgl_ak"]; ?></h2>
                    ...
                    <div class="row">
                        ...
                        $tgl = mysqli_query($link, "SELECT * FROM wdpc where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak'" . $syarat_tim . " AND status_del='0' group by tanggal,Unit order by tanggal desc, Unit asc") or die(mysqli_error($link));
                                    ...
                                    <table class="tables table-hover" border="1" rules="all">
                                        <thead>
                                            <tr class="tengah">
                                                ...
                                                <th style="font-size:10px;" rowspan="2" width="5%" class="tengah">Operator</th>
                                        ...
                                        <tbody>
                                            ...
                                            $total_pemakaianx = 0;
                                            $total_sisax = 0;
                                            $result = mysqli_query($link, "SELECT * FROM wdpc where tanggal='$r_tgl' AND Unit='$r_unit'" . $syarat_tim . " AND status_del='0' order by tanggal desc, Unit, shif asc ") or die(mysqli_error($link));
                                            ...
                                            ?>
                                                <tr class="tengah">
                                                    ...
                                                    <!--<td style="font-size:11px;<?php echo $warna;
                                                                                    $garisnya; ?>"><?php echo $tanggal; ?></td>-->
                                                    <!--<td style="font-size:11px;<?php echo $warna;
                                                                                    $garisnya; ?>"><p class="<?php echo $cls; ?>"><?php echo $unit; ?></p></td>-->
                                                    ...
                                                    <!--<td style="font-size:11px;<?php echo $warna;
                                                                                    $garisnya; ?>" ><p class="<?php echo $cls; ?>"><?php echo $jml_opt; ?></p></td>-->
                                                    <td style="font-size:11px;">
