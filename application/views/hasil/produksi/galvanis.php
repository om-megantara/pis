            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        $tgl = mysqli_query($link, "SELECT * FROM galvanis where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak'" . $syarat_tim . " AND status_del='0' group by tanggal,Unit order by tanggal desc, Unit asc") or die(mysqli_error($link));
                        // echo "SELECT * FROM galvanis where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak'" . $syarat_tim . " AND status_del='0' group by tanggal,Unit order by tanggal desc, Unit asc";
                                    ...
                                    <table class="tables table-hover" border="1" rules="all">
                                        <thead>
                                            <tr class="tengah">
                                                ...
                                                <!--<th style="font-size:10px;<?php echo $warna_jdlTabel;
                                                                                $garisnya; ?>" rowspan="2" width="5%" class="tengah">Tanggal</th>-->
                                                <!--<th style="font-size:10px;<?php echo $warna_jdlTabel;
                                                                                $garisnya; ?>" rowspan="2" width="5%" class="tengah">Unit</th>-->
                                                <th style="font-size:10px;" rowspan="2" width="2%" class="tengah">Team</th>
                                        ...
                                        <tbody>
                                            ...
                                            $total_pemakaianx = 0;
                                            $total_sisax = 0;
                                            $result = mysqli_query($link, "SELECT * FROM galvanis where tanggal='$r_tgl' AND Unit='$r_unit'" . $syarat_tim . " AND status_del='0' order by tanggal desc, Unit, shif asc ") or die(mysqli_error($link));
                                            // echo "SELECT * FROM galvanis where tanggal='$r_tgl' AND Unit='$r_unit'" . $syarat_tim . " AND status_del='0' order by tanggal desc, Unit, shif asc ";
                                            ...
                                            ?>
                                                <tr class="tengah">
                                                    ...
                                                    <td style="font-size:11px;">
                                                        <p class="<?php echo $cls; ?>"><?php echo $jml_opt; ?></p>
                                                    </td>
                                                    <td style="font-size:11px;">
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="font-size:12px;" colspan="4" class="tengah"><b>
