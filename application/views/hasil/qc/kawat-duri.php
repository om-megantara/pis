...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    ...
    <div class="col-lg-12">
        ...
        <form method="POST" action="<?= base_url('hasil/qc-kd'); ?>">
            <div class="row"></div>
            <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row"><br>
                    <div id="print-area-1" class="print-area">
                        ...
                        $result = mysqli_query($link, "SELECT * FROM qc_kd where tgl_produksi>='$tgl_aw' AND tgl_produksi<='$tgl_ak'" . $syarat_tim . "group by unit") or die(mysqli_error($link));
				    ...
				    <h3>FORM SERAH TERIMA HASIL PRODUKSI</h3>-->
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                ...
                                $tgl_aw = date_format(date_create($_POST["txttgl_aw"]), "Y-m-d");
                                $tgl_ak = date_format(date_create($_POST["txttgl_ak"]), "Y-m-d");
                                $tgl = mysqli_query($link, "SELECT * FROM qc_kd where tgl_produksi>='$tgl_aw' AND tgl_produksi<='$tgl_ak'" . $syarat_tim . "group by unit") or die(mysqli_error($link));
                                    ...
                                    <table class="tables table-hover" border="1" rules="all">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                $data = mysqli_query($link, "SELECT * FROM qc_kd where tgl_produksi>='$tgl_aw' AND tgl_produksi<='$tgl_ak' AND unit='$r_unit'order by tgl_produksi, shif asc") or die(mysqli_error($link));
