...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    <div class="page-content">
        ...
        <form method="POST" action="<?= base_url('hasil/bahan-bantu-galvanis'); ?>">
            <div class="row"></div>
            <div id="page-wrapper">
                            ...
                            <table class="tables table-hover" border="1" rules="all">
                                <thead>
                                    <tr class="tengah">
                                        ...
                                        <th style="font-size:10px;" width="9%" class="tengah">Tanggal</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">Unit</th>
                                        <th style="font-size:10px;" width="5%" class="tengah">Team</th>
                                        <th style="font-size:10px;" width="5%" class="tengah">Shif</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">Diameter</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">hcl</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">nh4cl</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">zncl2</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">zn</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">al</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">znal</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">pb</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">Abu Timah</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">Zn Cetakan</th>
                                        <th style="font-size:10px;" width="6%" class="tengah">Lead Ingot Cetak</th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    while ($r_tgl1 = mysqli_fetch_array($r_tgl)) {
                                        ...
                                        $tot_abu_timahx = 0;
                                        // $link = mysqli_connect("localhost:3307", "root", "", "produksi");
                                        $result = mysqli_query($link, "SELECT * FROM galvanis where tanggal='$r_tanggal'" . $syarat_tim . " AND status_del='0' order by tanggal desc, shif asc, diameter asc") or die(mysqli_error($link));
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            $zn_cetakan = $row["zn_cetakan"];
                                            $li_cetak = $row["li_cetak"];
                                    ?>
                                            <tr class="tengah">
                                                ...
                                                <td style="font-size:11px;"><?php echo $zn_cetakan; ?></td>
                                                <td style="font-size:11px;"><?php echo $li_cetak; ?></td>
                                        ...
                                        <?php
                                            ...
                                            $tot_znx = $tot_znx + $zn;
                                            $tot_alx = $tot_alx + $al;
                                            $tot_znalx = $tot_znalx + $znal;
                                            $tot_pbx = $tot_pbx + $pb;
                                            $tot_abu_timahx = $tot_abu_timahx + $abu_timah;
                                            // $tot_zn_cetakanx = $tot_zn_cetakanx + $zn_cetakan;
                                            ...
                                            $tot_zns = $tot_zns + $zn;
                                            $tot_als = $tot_als + $al;
                                            $tot_znals = $tot_znals + $znal;
                                            $tot_pbs = $tot_pbs + $pb;
                                            $tot_abu_timahs = $tot_abu_timahs + $abu_timah;
                                            // $tot_zn_cetakas = $tot_zn_cetakas + $zn_cetakan;
                                            // $tot_li_cetaks = $tot_li_cetaks + $li_cetak;
                                        }
                                        if ($tim == "Semua Tim") {
                                        ...
                                        ?>
                                            <tr>
                                                <td style="font-size:12px;color:blue" colspan="6" class="tengah"><b><?php echo "Total " . $r_tanggal; ?></b></td>
                                                ...
                                                <!-- <td style="font-size:12px;color:blue" class="tengah"><b><?php echo $tot_zn_cetakanx; ?></b></td> -->
                                                <td style="font-size:12px;color:blue" class="tengah"><b></b></td>
                                                <!-- <td style="font-size:12px;color:blue" class="tengah"><b><?php echo $tot_li_cetakx; ?></b></td> -->
                                                <td style="font-size:12px;color:blue" class="tengah"><b></b></td>
                                            </tr>
                                    <?php }
                                        $nox++;
                                    ...
                                    <tr>
                                        <td style="font-size:12px;color:green" colspan="6" class="tengah"><b><?php echo "Total Periode <br>" . $_POST["txttgl_aw"] . " sampai " . $_POST["txttgl_ak"]; ?></b></td>
                                        ...
                                        <!-- <td style="font-size:12px;color:green" class="tengah"><b><?php echo $tot_zn_cetakans; ?></b></td> -->
                                        <td style="font-size:12px;color:green" class="tengah"><b></b></td>
                                        <!-- <td style="font-size:12px;color:green" class="tengah"><b><?php echo $tot_li_cetaks; ?></b></td> -->
                                        <td style="font-size:12px;color:green" class="tengah"><b></b></td>
                                    </tr>
                                </tbody>
                            </table>
