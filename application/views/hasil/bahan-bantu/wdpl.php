...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    <div class="page-content">
        ...
        <form method="POST" action="?p=bahan-bantu-wdpl">
            <div class="row"></div>
            <div id="page-wrapper">
                        ...
                        <div class="page-content">
                            <table class="tables table-hover" border="1" rules="all">
                                ...
                                <tbody>
                                    ...
                                    //echo $tgl_aw."|".$tgl_ak;
                                    $r_tgl = mysqli_query($link, "SELECT * FROM wdpl where tanggal>='$tgl_aw' AND tanggal<='$tgl_ak'" . $syarat_tim . " AND status_del='0' group by tanggal order by tanggal asc") or die(mysqli_error($link));
                                    while ($r_tgl1 = mysqli_fetch_array($r_tgl)) {
                                        ...
                                        $tot_pbx = 0;
                                        $tot_abu_timahx = 0;
                                        $result = mysqli_query($link, "SELECT * FROM wdpl where tanggal='$r_tanggal'" . $syarat_tim . " AND status_del='0' order by tanggal desc, shif asc ") or die(mysqli_error($link));
                                    ...
                                    ?>
                                            <tr class="tengah">
                                                ...
                                                <!--<td style="font-size:11px;<?php echo $warna;
                                                                                $garisnya; ?>" ><?php echo $zncl2; ?></td>
                                <td style="font-size:11px;<?php echo $warna;
                                                            $garisnya; ?>" ><?php echo $zn; ?></td>
								<td style="font-size:11px;<?php echo $warna;
                                                            $garisnya; ?>" ><?php echo $al; ?></td>
								<td style="font-size:11px;<?php echo $warna;
                                                            $garisnya; ?>" ><?php echo $znal; ?></td>
								<td style="font-size:11px;<?php echo $warna;
                                                            $garisnya; ?>" ><?php echo $pb; ?></td>
								<td style="font-size:11px;<?php echo $warna;
                                                            $garisnya; ?>"><?php echo $abu_timah; ?></td>-->
