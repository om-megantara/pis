...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    ...
    <div class="col-lg-12">
        ...
        <form method="POST" action="<?= base_url('cetak/qc-galvanis'); ?>">
            <div class="row"></div>
            <div id="page-wrapper">
...
?>
    ...
    <!-- echo "<td width='20%'><a onclick='var w=window.open(this.href,width=1000,height=500,scrollbars)' href='?p=qc-galv-print' target='blank'><button type='submit'>Cetak</button></a></td>"; -->
<?php } ?>