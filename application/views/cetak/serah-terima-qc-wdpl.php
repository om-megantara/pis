...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    ...
    <div class="col-lg-12">
        ...
        <form method="POST" action="<?= base_url('cetak/terima-qc-wdpl'); ?>">
            <div class="row"></div>
            <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row"><br>
                    <div id="print-area-1" class="print-area">
                        ...
                        $result = mysqli_query($link, "SELECT * FROM qc_wdpl where tgl_produksi='$tgl'" . $syarat_tim . "group by unit") or die(mysqli_error($link));
                        ...
                        Tanggal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php //echo  date_format(date_create($tanggalx), "d-M-Y"); 
                                                                                                        ?><br>
                        Bagian/Unit &nbsp;&nbsp;:&nbsp;WDPL/<?php echo $unit; ?><br>
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                ...
                                $tgl = mysqli_query($link, "SELECT * FROM qc_wdpl where tgl_produksi='$tgl_aw'" . $syarat_tim . "group by unit") or die(mysqli_error($link));
                                    ...
                                    <table class="tables table-hover" border="1" rules="all">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                $data = mysqli_query($link, "SELECT * FROM qc_wdpl where tgl_produksi='$tgl_aw' AND unit='$r_unit'") or die(mysqli_error($link));
