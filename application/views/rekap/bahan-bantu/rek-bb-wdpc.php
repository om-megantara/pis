...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    <div class="page-content">
        ...
        <div class="col-lg-12">
            ...
            <form method="POST" action="<?= base_url('rekap/bahan-bantu-wdpc'); ?>">
                <div class="row"></div>
                <div id="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="col-lg-12">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <h2>Laporan Rekapitulasi Pemakaian Bahan Pembantu WD PC: <?php echo $_POST["txttgl_aw"] . " sampai " . $_POST["txttgl_ak"]; ?></h2>
                            ...
                            <table class="tables table-hover" border="1" rules="all">
                                ...
                                while ($r_tgl2 = mysqli_fetch_array($r_tgl1)) {
                                    ...
                                    while ($row = mysqli_fetch_array($r_tgl)) {
                                        ...
                                        $tanggal = $row["tanggal"];
                                        $baik_roll = mysqli_fetch_array(mysqli_query($link, "SELECT sum(bahan_bantu1) as 'Bban_hcl' FROM wdpc where tanggal like '$tanggal2' and diameter='$r_diameter'" . $syarat_tim . " AND status_del='0' group by diameter order by tanggal"));
                                        $lubri = $baik_roll['Bban_hcl'];
                                        $baik_kg = mysqli_fetch_array(mysqli_query($link, "SELECT sum(bahan_bantu2) as 'Bban_nh4cl' FROM wdpc where tanggal like '$tanggal2' and diameter='$r_diameter'" . $syarat_tim . " AND status_del='0' group by diameter order by tanggal"));
