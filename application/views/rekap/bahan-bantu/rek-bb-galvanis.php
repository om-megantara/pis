...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    <div class="page-content">
        ...
        <form method="POST" action="?p=bahan-bantu-galvanis">
            <div class="row"></div>
            <div id="page-wrapper">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <?php
                                            ...
                                            $tot_zn_cetakx = $tot_zn_cetakx + $zn_cetakan;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="font-size:12px;color:blue" class="tengah"><b><?php echo $tot_abu_timahx; ?>
                                                <td style="font-size:12px;color:blue" class="tengah"><b><?php echo $tot_zn_cetakx; ?>
                                                <td style="font-size:12px;color:blue" class="tengah"><b><?php echo $tot_li_cetaks; ?></b></td>
                                            </tr>
                                    <?php }
                                        $nox++;
                                    } ?>
                                    <tr>
                                        ...
                                        <td style="font-size:12px;color:green" class="tengah"><b><?php echo $tot_zn_cetakas; ?></b></td>
