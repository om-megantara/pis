...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    ...
    <div class="page-content">
        ...
        <div class="col-lg-12">
            <h3>Pilih Tanggal Permintaan:</h3>
            <form method="POST" action="<?= base_url('rekap/cetak-permintaan-brg'); ?>">
                <div class="row"></div>
                <div id="page-wrapper">
...
?>
    ...
    //$result4=mysqli_query($link, "SELECT * FROM gudang_paku_permintaan where tanggal='$tgl' ") or die(mysqli_error($link));
    ...
    <div id="print-area-1" class="print-area">
        ...
        <body>
            ...
            $result = mysqli_query($link, "SELECT * FROM gudang_paku_permintaan where tanggal='$tgl' And status_gudang='$stat_gud'") or die(mysqli_error($link));
            ...
            ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table style="margin-bottom: 0;" class="tables table-hover" border="0" rules="none">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:11px;width:15%">FOM-PPC-04-01</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="width:5%">&nbsp;</td>
                                    <td style="font-size:16px;font-weight: bold;" class="tengah" rowspan="2">PERMINTAAN BAHAN BAKU DAN JADI</td>
                                        ...
                                        <div class="row">
                                            <table class="tables table-hover" border="1" rules="all">
                                                ...
                                                <tbody>
                                                    ...
                                                    $beratx = 0;
                                                    // $link = mysqli_connect("localhost:3307", "root", "", "produksi");
                                                    $r_tgl = mysqli_query($link, "SELECT * FROM gudang_paku_permintaan where tanggal='$tgl' and status_gudang='$stat_gud'  and diameter='$dia' group by kode_barang order by diameter asc") or die(mysqli_error($link));
						...
						<tr>
							<td style="font-size:12px;width:5%" ><b>Gudang Bufer: <?php echo " " . $gudang1; ?></b></td>
						</tr>
						</table>-->
                                            <?php //} 
                                            ?>
