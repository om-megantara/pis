...
<?php if (isset($_POST["btn_proses"]) == "") { ?>
    ...
    <div class="col-lg-12">
        ...
        <form method="POST" action="<?= base_url('rekap/ng-wdpl'); ?>">
            <div class="row"></div>
            <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        $tgl = mysqli_query($link, "SELECT * FROM qc_wdpl where tgl_produksi>='$tgl_aw' AND tgl_produksi<='$tgl_ak'" . $syarat_tim . " group by tgl_produksi,unit order by tgl_produksi desc, unit asc") or die(mysqli_error($link));
                                ...
                                <div class="container-fluid">
                                    ...
                                    <table class="tables table-hover" border="1" rules="all">
                                        ...
                                        <tbody>
                                            ...
                                            // $link = mysqli_connect("localhost:3307", "root", "", "produksi");
                                            $result = mysqli_query($link, "SELECT * FROM qc_wdpl where tgl_produksi='$r_tgl' AND unit='$r_unit'" . $syarat_tim . " order by tgl_produksi desc, unit, shif asc ") or die(mysqli_error($link));
